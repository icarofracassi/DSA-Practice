...
A primeira linha da entrada contém um inteiro N (3 ≤ N ≤ 105), o número de vértices do polígono. Seguem N linhas, cada uma com dois inteiros x, y (-10ˆ6 ≤ x, y ≤ 10ˆ6), os vértices do polígono. A última linha da entrada contém quatro inteiros, Ax, Ay, Bx e By (-10ˆ6 Ax, Ay, Bx, By ≤ 10ˆ6), as coordenadas x e y de A e as coordenadas x e y de B, respectivamente. Os pontos da entrada serão dados na ordem correta em que aparecem no polígono, no sentido horário ou anti-horário. Não haverá pontos repetidos e o polígono será convexo.
